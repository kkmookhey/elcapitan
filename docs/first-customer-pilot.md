...
- Two or more findings covered by deterministic El Capitan validators. Use
  ...
  controls, eight RDS DB-instance controls, twenty EC2 security-group controls,
  and two EBS volume controls. Only S3 object versioning supports planning, and
  there is no AWS mutation authority.
